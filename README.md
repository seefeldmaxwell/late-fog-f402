...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/late-fog-f402)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/late-fog-f402
```

A live public deployment of this template is available at [https://late-fog-f402.templates.workers.dev](https://late-fog-f402.templates.workers.dev)
